...
if __name__ == "__main__":
    # Correct registered CTP files

    """
    # MRCLEAN late is flipped in Z axis 
    cta_file = "/scratch/amartinezmora/raw_data/cta/mrclean_late_30245.nii.gz"
    out_file = "/scratch/amartinezmora/raw_data/cta/mrclean_late_30245_mod_v2.nii.gz"
    ...
    image_flip = sitk.GetImageFromArray(img_flip)
    image_flip.CopyInformation(image)
    sitk.WriteImage(image_flip, out_file)
    """