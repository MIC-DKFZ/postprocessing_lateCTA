...
def main(args):
    ...
    tta_folder = args.t  # Folder with time-vessel map data
    ...
    assert os.path.exists(tta_folder), f"Model folder '{tta_folder}' does not exist"
    ...
    for i, file in enumerate(files):
        ...
        tta_file = os.path.join(tta_folder, file)
