...
if __name__ == "__main__":
    ...
    out_folder = "/scratch/amartinezmora/raw_data/ctp_registered_to_atlas"
    ...
    transform_matrix = get_transformation_matrix(fixed=atlas_image, moving=t0_image, clipvalue=[None, None], parameters=p)
